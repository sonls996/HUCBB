function removeValue(){
    var x=document.getElementById('returnvalue');
    x.value =" ";
}
function clearValue(){
    var x = document.getElementById('returnvalue');
...
var thongbao=[
  ...
  "Tình hình bệnh dịch viêm đường hô hấp cấp Covid-19 hiện nay diễn biến rất phức tạp, để đảm bảo an toàn cho sức khỏe của toàn bộ nhân sự công ty, giám đốc tập đoàn đã ra quyết định cho tất cả các nhân sự được nghỉ tránh dịch ( có lương) bắt  đầu từ ngày mai",
  "thông báo 2",
  "thông báo 3",
  "thông báo 4"
]
function addNew(){
  var hotnew=document.getElementsByClassName("marquee");
  hotnew.innerHTML="<marquee direction='left'>hi</marquee>";
  alert("sucess");
  for(i=0; i<thongbao.length;i++){
    console.log(thongbao[i]);
    
    hotnew.innerHTML="<marquee>  thongbao[i] </marquee>";
    break;  
  }
  console.log("Click thành công"+ hotnew);
}
